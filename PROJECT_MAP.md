...
> Обновлено: 2026-09-14 (ночь) · актуально для v2.0.2 «Ливень» — **ОПУБЛИКОВАН** (GitHub Releases, Full 149.4МБ, Latest; апдейтер друзей подхватит за сутки / «Проверить сейчас» в меню B)
