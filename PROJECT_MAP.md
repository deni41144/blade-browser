...
> Обновлено: 2026-09-13 · актуально для v2.0.0 «Переплавка» (не опубликована)
> **В РАБОТЕ: Blade 2.0 «Переплавка»** — суперглобальный рефакторинг-релиз со своим
> сетапом. Большой план: `ROADMAP-2.0.md` (статус: на утверждении владельца).
