...
> Обновлено: 2026-09-12 · актуально для v1.7.5 «Первый Луч»
...
| BladeNewtab.uc.js | 1.1.1 | Hero на новой вкладке: приветствие по времени, погода+прогноз 3 дня, тикер хроники (chrome-оверлей; данные Clock через шину BladeCore) |
...
| BobliksChromeStyle 1.2.1 / AboutStyle 1.0.1 / BladeSounds 1.0.1 | — | Стили хрома/about (incl. порт SIGNATURE), звуки |
...
| 1.7.5 | Первый Луч | Фиксы 1.7.4: «обнажение клинка» оживлено по-настоящему (линия на .urlbar::after, конфликт position с движком устранён — сверка с omni.ja); приветствие newtab анимировано (появляется и тает). Не опубликован — на визуальной проверке |
