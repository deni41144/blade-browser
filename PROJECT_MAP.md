...
> Обновлено: 2026-09-15 (ночь) · актуально для v2.0.3 «Молния» — **ОПУБЛИКОВАН** (GitHub Releases, Patch 10.3МБ, Latest; апдейтер друзей подхватит за сутки / «Проверить сейчас» в меню B)
